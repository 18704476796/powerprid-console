...
import TablesThree from './components/TablesThree' // 扣分详情表格
...
export default {
  ...
  methods: {
    ...
    edit (obj) { // 编辑人员资质
      ...
      let orgId = parseInt(obj.orgId)
      this.ruleForm.orgId = orgId // 单位id
      let deptId = parseInt(obj.deptId)
      this.ruleForm.deptId = deptId // 部门id
      let groupId = parseInt(obj.groupId)
      this.ruleForm.groupId = groupId // 班组id
      let postId = parseInt(obj.postId)
      this.ruleForm.postId = postId // 岗位id
    ...
    changeDw (val) { // 获取部门下拉列表
      Request.getBmList(this, this.ruleForm.orgId)
    },
    getBz (val) { // 获取班组下拉列表
    ...
    lookInfo (obj) { // 查看三种人管理
      ...
      this.ruleForm.idCard = obj.idCard // 身份证号
      this.ruleForm.pointsDeductedCount = obj.pointsDeductedCount // 分数
      this.ruleForm.orgId = obj.orgName
      this.ruleForm.deptId = obj.deptName
      this.ruleForm.groupId = obj.groupName
      this.ruleForm.postId = obj.postName
      this.ruleForm.jobTypeId = obj.jobTypeId // 类别id
      this.ruleForm.professionId = obj.professionId // 专业
    ...
    lookGrade (id) { // 查看分数
      ...
      this.userId = id
      Request.lookGrade(this, id, this.gradeYaer)
    },
    gradeYaerSearch () { // 查询年份扣分详情
      Request.lookGrade(this, this.userId, this.gradeYaer)
    }
  },
  data () {
